...
class EmailAPI {
  ...
  Future<bool> sendConfirmationEmail(String address, String eventName, String personName, String bookName, String eventDate, String bookInfo) async {
    ...
    var body =
        ...
        "<p>Siamo lieti di informarti che la tua prenotazione a nome di <b>$bookName</b> è stata confermata con successo.</p>\r\n"
        ...
        "</ul>\r\n"
        "<p>Se hai bisogno di modificare o cancellare la prenotazione, contattaci rispondendo a questa email.</p>\r\n"
        "<p>Ti aspettiamo!</p>\r\n"
